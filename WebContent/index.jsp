...
<meta name="description" content="Banii mei - Primul serviciu de gestionare a finantelor proprii, special conceput pentru romani!">
<meta name="keywords" content="bani, contabilitate, gestiune, social financing, romani, romania, aplicatie romaneasca, romanian application">
...
<noscript><a href="http://www.histats.com" target="_blank"><img  src="http://sstatic1.histats.com/0.gif?3272314&101" alt="counter create hit" border="0"></a></noscript>
<!-- Histats.com  END  -->
...
<div class="container">
  <div class="sidebar">
    ...
    <div class="subscription">
      <form class="subscription_form"  action="SubscribeServlet" method = "post">
        <span class="border">
        <input name="email" class="subscription_line email" type="text">
        </span>
        <input name="send" type="submit" class="subscription_button" value="Trimite">
      </form>
        <form class="subscription_form"  action="ViewDocummentationServlet" method = "post">
      
        <input name="send" type="submit" class="subscription_button" value="Vezi mai multe informatii!">
      </form>
    ...
    <div class="social">
      ...
      <ul class="social_icons">
        ...
        <li><a class="facebook show-tooltip" title="Facebook" href="https://www.facebook.com/baniimeiro/"></a></li>
...
<div id="footer">
  <div class="container"> © 2015 Banii mei - Reinventam Economiile. Impreuna </div>
</div>
</body>
</html>