			...
			<section class="wrapper"
				...
				<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
					<div class="page-title">
						...
						<div class="pull-left">
							<h1 class="title">Adauga un castig nou</h1>
						</div>
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					<section class="box ">
						<header class="panel_header">
							<h2 class="title pull-left">Detalii castig</h2>
								...
								<div class="col-md-12">
									...
									<div class="col-md-12">
										...
										<select class="form-control input-lg m-bot15" id="sursaCastig"
												...
												earningSources = new EarningSources().getUserEarningSources(currentUser);
		...
		<div class="modal-dialog animated zoomInDown">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title">Adauga o sursa noua de venit</h4>
				</div>
				<div class="modal-body">
					<form action="CreateEarningSourceServlet" method="post"
						id="createEarningSourceForm" name="createEarningSourceForm">
						<div class="form-group">
							<label class="form-label" for="field-1">Nume</label> <span
								class="desc">e.g. "Salarii"</span>
							<div class="controls">
								<input type="text" class="form-control" id="numeSursa"
									name="numeSursa">
							</div>
						</div>
						<div class="form-group">
							<label class="form-label" for="field-1">Descriere</label> <span
								class="desc">e.g. "Salariile de la compania mea"
								nicotina"</span>
							<div class="controls">
								<input type="text" class="form-control" id="descriereSursa"
									name="descriereSursa">
							</div>
						</div>
