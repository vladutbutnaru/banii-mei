 ...
 */
@WebServlet("/CreateCashAccountServlet")
public class CreateCashAccountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateCashAccountServlet() {
        super();
	...
	account.setUserID(user.getId());
      accountCreator.createCashAccount(account);
