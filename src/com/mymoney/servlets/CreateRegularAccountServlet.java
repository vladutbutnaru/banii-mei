 ...
 */
@WebServlet("/CreateRegularAccountServlet")
public class CreateRegularAccountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateRegularAccountServlet() {
        super();
	...
	account.setUserID(user.getId());
      accountCreator.createRegularAccount(account);
