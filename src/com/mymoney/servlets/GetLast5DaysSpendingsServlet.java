...
/**
 * Servlet implementation class GetLast5DaysSpendingsServlet
 */
@WebServlet("/GetLast5DaysSpendingsServlet")
public class GetLast5DaysSpendingsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetLast5DaysSpendingsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sums = transactionDAO.getAmountSpentLast5Days(currentUser);
